                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6" >
                                <asp:Button class="btn btn-lg btn-primary btn-Primary" ID="Button2" runat="server" Text="Issue" />
                                     
                               </div> 
                           

                            <div class="col-6" >
                                <asp:Button class="btn btn-lg btn-primary btn-Success" ID="Button4" runat="server" Text="Return" />
