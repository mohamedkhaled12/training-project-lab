                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6" >
                                <asp:Button class="btn btn-lg btn-primary btn-Primary" ID="Button2" runat="server" Text="Issue" OnClick="Button2_Click" />
                                     
                               </div> 
                           

                            <div class="col-6" >
                                <asp:Button class="btn btn-lg btn-primary btn-Success" ID="Button4" runat="server" Text="Return" OnClick="Button4_Click" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="col" >
                                <asp:GridView class="table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="1189px">
                                    <Columns>
                                        <asp:BoundField DataField="member_id" HeaderText="Member ID" SortExpression="member_id" />
                                        <asp:BoundField DataField="member_name" HeaderText="Mmember Name" SortExpression="member_name" />
