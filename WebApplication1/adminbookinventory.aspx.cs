    ...
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        void fillAuthorPublisherValues()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT author_name from auhtor_master_tbl;", con);
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id,book_name,type,author_name,publisher_name,publish_date,language,edition,book_cost,no_of_pages,book_description,actual_stock,current_stock,book_img_link) values(@book_id,@book_name,@type,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@current_stock,@book_img_link)", con);
        ...
        void getBookByID()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    ...
                    string[] genre = dt.Rows[0]["type"].ToString().Trim().Split(',');
